...
export const plans = [
  {
    ...
    iconBg: 'from-brand-400 via-brand-500 to-brand-600',
    glowColor: 'teal',
    ...
    buttonGradient: 'from-brand-600 via-brand-500 to-brand-400',
    limits: {
      products: 50,
      storage: '5GB',
      bandwidth: '50GB',
  ...
  },
  {
    ...
    buttonText: 'ابدأ الآن',
    buttonGradient: 'from-gold-600 via-gold-700 to-gold-800',
    limits: {
      products: 200,
      storage: '20GB',
      bandwidth: '200GB',
  ...
  },
  {
    ...
    annualPrice: 9999,
    iconName: 'Star',
    iconBg: 'from-walnut-500 via-walnut-600 to-walnut-700',
    glowColor: 'walnut',
    ...
    buttonGradient: 'from-walnut-600 via-walnut-700 to-walnut-800',
    limits: {
      products: 3000,
      storage: 'Unlimited',
      bandwidth: 'Unlimited',

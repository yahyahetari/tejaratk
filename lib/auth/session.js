...
// Dynamic import for prisma to avoid static analysis issues
...
// كاش الجلسات في الذاكرة (60 ثانية) لتجنب استعلام DB في كل طلب
const sessionCache = new Map();
const SESSION_CACHE_TTL = 60 * 1000; // 60 ثانية
...
export async function getSession() {
  try {
    ...
    // تنظيف الكاش القديم كل 100 عنصر
